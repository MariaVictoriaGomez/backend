...
INSERT INTO `consulta` VALUES (1,1,'gfdh','2024-01-07'),(2,1,'test1','2024-02-07'),(3,1,'test','2024-02-07'),(4,1,'test 2','2024-02-07'),(5,1,'test merch cuso','2024-02-07');
...
CREATE TABLE `tipo_x_consulta` (
  ...
  KEY `fk_tipoconsulta_idx` (`idtipoconsulta`),
  CONSTRAINT `fk_idconsulta` FOREIGN KEY (`idconsulta`) REFERENCES `consulta` (`idconsulta`),
  CONSTRAINT `fk_tipoconsulta` FOREIGN KEY (`idtipoconsulta`) REFERENCES `tipoconsulta` (`idtipoconsulta`)
...
INSERT INTO `tipousuario` VALUES (1,'admin',1),(2,'cliente',1),(3,'admin',1),(4,'cliente',1),(5,'admin',1),(6,'cliente',1),(7,'admin',1),(8,'cliente',1);
...
-- Dump completed on 2024-07-02 12:00:43
